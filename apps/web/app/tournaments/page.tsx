    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 pb-20">
        <div className="page-container pt-12">
          ...
          {/* Stats Banner */}
          <div className="glass rounded-2xl p-6 mb-8 animate-fade-in-up animate-delay-200">
          ...
          {/* Filter Tabs */}
          <div className="flex items-center gap-2 mb-8 overflow-x-auto pb-2 animate-fade-in-up animate-delay-300">
            {FILTER_TABS.map((tab) => {
